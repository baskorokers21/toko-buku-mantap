...
<html lang="en" dir="ltr">
   <head>
     ...
     <style>
       body{
 background-image: url('tumpuk.jpg');
...
height: 100%;
   ...
   <body>
     <nav class="navbar navbar-expand-md bg-secondary navbar-dark stiky-top">
      <a href="#">
        <img src="buk.png" width="100" alt="">
      </a>
        ...
        <?php foreach ($query as $buku ): ?>
          <div class="card col-4">
            <div class="card-body">
              ...
              <h5 class="text-secondary"><?php echo $buku["judul"]; ?></h5>
              <h6 class="text-success">Rp <?php echo $buku["harga"]; ?></h6>
            </div>
